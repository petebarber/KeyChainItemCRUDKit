#
#  Be sure to run `pod spec lint KeyChainItemCRUDKit.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/petebarber/KeyChainItemCRUDKit.git", :tag => "0.0.1" }
